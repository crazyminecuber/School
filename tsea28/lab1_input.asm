...
getkey:
	...
	;movt r1,#(GPIOB_GPIODATA >> 16)
	 mov r0,#(UART0_UARTFR & 0xffff)
    movt r0,#(UART0_UARTFR >> 16)
...
waitinput:
    ...
    ldr	r4,[r0]
    ands r4,#0x10  ; Testa bit 4
    bne waitinput  ; inget data att hämta

    mov r0,#(UART0_UARTDR & 0xffff)
    movt r0,#(UART0_UARTDR >> 16)
    ldr r4,[r0]
...
siffra:
    cmp r4,#0x0f
    bhi waitinput ; inte tecken 0-9 eller A-F, vänta igen
    bx lr
