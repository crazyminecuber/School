...
solved_u_ut = solve((eq9, eq10, eq11, eq12, eq13, eq14, eq15, eq16, eq17), u_ut, u_gs1, i_b, u_1, i_2, u_2, R_p1, R_p2, u_gs2)
print("R_2: " + latex(solved_r2[0]))
print("R_3: " + latex(solved_r3[0]))
print("R_{D1}: " + latex(solved_r_d1[0]))
print("u_{ut}: " + latex(solved_u_ut))